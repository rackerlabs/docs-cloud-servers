...
Retrieve lis of server actions
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. code::

    POST /servers/{server_id}/os-instance-actions
...
**Example Retrieve lis of server actions: JSON request**
...
**Example Retrieve lis of server actions: JSON response**
