...
-  :ref:`Create a virtual interface with nova<create-virt-interface-with-nova>`
-  :ref:`Create a virtual interface with cURL<create-virt-interface-with-curl>`

.. toctree::
   :maxdepth: 2
   
   create-virt-interface-nova
   create-virt-interface-curl