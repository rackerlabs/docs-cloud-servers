...
To create an isolated network, you specify a name for your network and a Classless 
...
-  You can create up to ten isolated networks with up to 64 servers attached to each one.

-  After you create an isolated network, you cannot rename it.

After you create an isolated network, copy its network ID. You use this ID to attach the 
network to your server when you create your server.

**Next step:** Choose one of the following methods:

-  :ref:`Creating network with nova<creating-network-with-nova>`
-  :ref:`Creating network with cURL<creating-network-with-curl>`
