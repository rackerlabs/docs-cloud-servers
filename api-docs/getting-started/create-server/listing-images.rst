...
After you choose an image, copy its image ID. You use this image ID when you create the 
server.
...
-  :ref:`Listing images with nova<listing-images-with-nova>`
-  :ref:`Listing images with cURL<listing-images-with-curl>`
