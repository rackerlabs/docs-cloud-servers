...
networks that you have created, as well as the Rackspace public and private networks.
...
-  :ref:`Listing servers with nova<listing-servers-with-nova>`
-  :ref:`Listing servers with cURL<listing-servers-with-curl>`

.. toctree::
   :maxdepth: 2
   
   listing-servers-nova
