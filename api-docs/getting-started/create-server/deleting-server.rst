...
It can take a few minutes to delete your server. After the server is deleted, it no longer 
appears in the list of servers.
...
-  :ref:`Deleting server with nova client <deleting-server-with-nova>`
-  :ref:`Deleting server with cURL <deleting-server-with-curl>`


.. toctree::
   :maxdepth: 2

   deleting-server-nova
